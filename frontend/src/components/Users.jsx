            ...
            <div className="space-y-3 p-3">
              {users.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm">Henüz kullanıcı bulunmuyor</p>
                  <p className="text-gray-500 text-xs mt-1">Yeni kullanıcılar eklendiğinde burada görünecek</p>
                </div>
              ) : (
                users.map((user) => (
                  <div
          ...
          <div className="hidden sm:block">
            {users.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-gray-300 text-lg font-medium mb-2">Henüz kullanıcı bulunmuyor</h3>
                <p className="text-gray-500 text-sm">Yeni kullanıcılar eklendiğinde burada görünecek</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
